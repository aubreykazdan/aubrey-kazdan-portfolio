...
function changeImageOneRight() {
  if (imgOne.src.match("./assets/projects/movies1.png")) {
    ...
    imgOne.alt =
      "A preview of the Movies A-to-Z app displayed on an iPhone 11 6.1 inch display";
  } else if (imgOne.src.match("./assets/projects/movies2.png")) {
    imgOne.src = "./assets/projects/movies3.png";
    imgOne.alt =
      "A preview of the Movies A-to-Z app displayed on an iPad 9.7 inch display";
  } else {
    imgOne.src = "./assets/projects/movies1.png";
    imgOne.alt =
      "A preview of the Movies A-to-Z app displayed on a Macbook Pro 16 inch display";
  }
}
...
function changeImageTwoRight() {
  if (imgTwo.src.match("./assets/projects/podcast1.png")) {
    ...
    imgTwo.alt =
      "A preview of the Podcast Prioritizer app displayed on an iPhone 11 6.1 inch display";
  } else if (imgTwo.src.match("./assets/projects/podcast2.png")) {
    imgTwo.src = "./assets/projects/podcast3.png";
    imgTwo.alt =
      "A preview of the Podcast Prioritizer app displayed on an iPad 9.7 inch display";
  } else {
    imgTwo.src = "./assets/projects/podcast1.png";
    imgTwo.alt =
      "A preview of the Podcast Prioritizer app displayed on a Macbook Pro 16 inch display";
  }
}
...
function changeImageThreeRight() {
  if (imgThree.src.match("./assets/projects/surviving1.png")) {
    ...
    imgThree.alt =
      "A preview of the Surviving Bootcamp app displayed on an iPhone 11 6.1 inch display";
  } else if (imgThree.src.match("./assets/projects/surviving2.png")) {
    imgThree.src = "./assets/projects/surviving3.png";
    imgThree.alt =
      "A preview of the Surviving Bootcamp app displayed on an iPad 9.7 inch display";
  } else {
    imgThree.src = "./assets/projects/surviving1.png";
    imgThree.alt =
      "A preview of the Surviving Bootcamp app displayed on a Macbook Pro 16 inch display";
  }
}
...
console.log(
  "%cOh hey there :)",
  "color: skyblue; font-family:sans-serif; font-size: 20px"
);

console.log(
  "%cWhat is the high speed velocity of an unladen swallow?",
  "color: pink; font-family:sans-serif; font-size: 17px"
);
